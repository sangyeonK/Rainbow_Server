...
module.exports = function(req, res) {
    ...
    var params = common.checkRequest( req, ["groupSN","year"] );
    ...
    step(
        ...
        function (err, conn) 
        {
            ...
            var startTimestamp = common.makeUnixTime( params.year, 1, 1 );
            var endTimestamp = common.makeUnixTime( params.year+1, 1, 1 );
