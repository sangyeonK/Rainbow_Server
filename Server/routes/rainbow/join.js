...
module.exports = function(req, res) {
  ...
  if( !validator.isLength( params.password , 6 ) || !validator.matches( params.password, "[a-z]", "i") || !validator.matches( params.password, "[0-9]" ) ) {
    return responsor( common.error(11) , res );
  }

  params.password = auth.encryptPasswd(params.password);
