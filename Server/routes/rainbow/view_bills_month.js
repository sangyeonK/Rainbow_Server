...
module.exports = function(req, res) {
    ...
    var reqAnalysis = util.checkRequest( req, ["groupSN","year","month"] );
    ...
    step(
        ...
        function (err, conn) 
        {
            ...
            var startTimestamp = util.makeUnixTime( params.year, params.month, 1 );
            var endTimestamp = util.makeUnixTime( params.year, params.month + 1, 1 );
