...
module.exports = function(req, res) {
    ...
    var params = common.checkRequest( req, ["groupSN","year","month"] );
    ...
    step(
        ...
        function (err, conn) 
        {
            ...
            var startTimestamp = common.makeUnixTime( params.year, params.month, 1 );
            var endTimestamp = common.makeUnixTime( params.year, params.month + 1, 1 );
